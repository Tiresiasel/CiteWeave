...
def _load_cli_module():
    ...
    class FakeKernel:
        ...
        def paper_index_snapshot(self, search="", author="", limit=20):
            return {
...
class CliPapersCommandTests(unittest.TestCase):
    def test_handle_papers_command_supports_json_output_without_pdf_paths(self):
        ...
        buf = io.StringIO()
        with redirect_stdout(buf):
            cli.handle_papers_command(Namespace(search="network", author="", limit=5, json=True))
    ...
    def test_handle_papers_command_renders_empty_guidance(self):
        ...
        buf = io.StringIO()
        with redirect_stdout(buf):
            cli.handle_papers_command(Namespace(search="Porter", author="", limit=20, json=False))
